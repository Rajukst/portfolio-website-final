            ...
            <AnimationWrapper>
              <div className="m-2 project">
                ...
                <p>
                  ...
                  This company sells various kinds of handmade woodcraft
                  products. User can purchase product, cancel his/her order; see
                  his/her order on dashboard, review products. <br /> • It also
                  has an admin dashboard. Admin can make a new Admin, Add a new
                  Product, and manage all users order. <br />• It is a SPA
                  (Single Page Application), responsive and user friendly.
                </p>
                <h6
                  className="mb-3"
                  style={{
            ...
            <AnimationWrapper>
              <div className="m-2 project">
                ...
                <p>
                  ...
                  are implemented. Admin can add a new service. Admin can see
                  all users’s booking.
                  <br />• It is a SPA (Single Page Application), responsive.
                  User can use it on mobile, tablet or large Device.
                </p>
                <h6
                  className="mb-3"
                  style={{
            ...
            <AnimationWrapper>
              <div className="m-2 project">
                ...
                <p>
                  ...
                  <br />• Registration and login system are implemented. User
                  can register here or signup with Google. After login users can
                  see doctor's lists, medical services.
